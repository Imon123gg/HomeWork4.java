...
public class Main {
    ...
    public static List<String> correctedList(List<String> stringList) {
        List<String> arrayList = new ArrayList<>(STRING_LIST);
    ...
    public static HashMap<String, Integer> magSort(HashMap<String, Integer> shopCart) {
        HashMap<String, Integer> correctHashMap = new HashMap<>();
        for (Map.Entry<String,Integer> entry : setMagazine().entrySet()){
            if(entry.getValue() < 300) correctHashMap.put(entry.getKey(), entry.getValue());
